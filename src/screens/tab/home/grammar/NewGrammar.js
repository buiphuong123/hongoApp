...
export default NewGrammar = ({ navigation, route }) => {
        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ flex: 2}}>
                <View style={{ justifyContent: 'center', padding: 10, }}>
                    <Text style={{ textAlign: 'center', fontSize: 18, fontWeight: 'bold', color: colors.text }}>Tạo ngữ pháp mới</Text>
                </View>
                <View style={{}}>
                    ...
                    <View style={{ padding: 10 }}>
                        ...
                        <View>
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <TextInput
                                    style={{color: colors.text, marginLeft: 10, borderBottomWidth: 1,borderBottomColor: colors.text_of_input, paddingBottom: -10, width: '90%' }}
