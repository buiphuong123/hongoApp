...
import { Text, View, ActivityIndicator, SafeAreaView, TouchableOpacity, StyleSheet, Dimensions } from 'react-native'
import CustomHeader from '../../CustomHeader';
import axios from "axios";
import { useSelector, useDispatch } from 'react-redux';
import { getGrammarRequest, getListGrammarLevel } from '../../../redux/actions/grammar.action';
import { getListWordRequest, getListWordLevel, getlocalWord } from '../../../redux/actions/word.action';
...
const HomeScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        // readFile(filePath);
        // console.log(users);
        axios.get('https://nameless-spire-67072.herokuapp.com/language/getListUser', {
            headers: {
        ...
        messaging().onNotificationOpenedApp(remoteMessage => {
            if (remoteMessage) {
                ...
                if (kakaa.type === 'word') {
                    ...
                    navigation.navigate("WordScreenDetail", { navigation: navigation, vocabularys: dataaa });
                }
                    ...
                    navigation.navigate("ListWordVocabulary", { navigation: navigation, listdata: dataaa, type: 2 });

                }
                else if(kakaa.type === 'schedule') {
                    navigation.navigate("ViewCalendar", { navigation: navigation, calen:  dataaa});
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', paddingBottom: 10, backgroundColor: colors.block, paddingTop: 10 }}>
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    <TouchableOpacity
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor:colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    ...
                    >
                        <Feather name={'book-open'} size={40} style={{ color: colors.header, }} />
                    </TouchableOpacity>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    ...
                    >
                        <Entypo name={'newsletter'} size={40} style={{ color: colors.header }} />
                    </TouchableOpacity>
            ...
            {users.role!== 1?
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', paddingBottom: 10, backgroundColor: colors.block, }}>
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    <TouchableOpacity
                        // style={{ borderWidth: 1, borderRadius: 40, backgroundColor: '#009387', borderColor: '#009387', bottom: 30, right: 30, position: 'absolute' }}
                        onPress={() => navigation.navigate("TestWord", {lession:1})}
                    >
                        <AntDesign name={'book'} size={40} style={{ color: colors.header  }} />
                    </TouchableOpacity>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    ...
                    >
                        <FontAwesome name={'leanpub'} size={40} style={{ color: colors.header  }} />
                    </TouchableOpacity>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    ...
                    >
                        <SimpleLineIcons name={'book-open'} size={40} style={{ color:colors.header  }} />
                    </TouchableOpacity>
...
: null}
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', paddingBottom: 10, backgroundColor: colors.block }}>
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    ...
                    >
                        <FontAwesome name={'book'} size={40} style={{ color: colors.header  }} />
                    </TouchableOpacity>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    ...
                    >
                        <Ionicons name={'book-outline'} size={40} style={{ color: colors.header  }} />
                    </TouchableOpacity>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: colors.color_of_light, paddingBottom: 10, paddingTop: 10, width: WIDTH / 3 - 5 }}>
                    ...
                    >
                        <FontAwesome5 name={'book-reader'} size={40} style={{ color: colors.header }} />
                    </TouchableOpacity>
