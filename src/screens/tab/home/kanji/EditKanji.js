...
export default EditKanji = ({ navigation, route }) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <CustomHeader title={"Chỉnh sửa chữ hán"} navigation={navigation} />
            <ScrollView style={{ flex: 1 }}>
                <View style={{ justifyContent: 'center', padding: 10, }}>
                    <Text style={{ textAlign: 'center', fontSize: 18, fontWeight: 'bold', color: colors.text }}>Chỉnh sửa chữ hán</Text>
                </View>
                <View style={{}}>
                ...
                <TouchableOpacity
                    ...
                    <Text style={{ textAlign: 'center', color: '#fff' }}>Sửa</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    )
